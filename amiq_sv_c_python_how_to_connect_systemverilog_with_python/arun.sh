...
# Usage:  arun.sh    [-tool  { irun | questa | vcs} ] --> specify what simulator to use (default: irun)"
#
#              arun.sh  -h[elp]                      --> print this message"
# Example of using : ./arun.sh -tool irun
#******************************************************************************/
...
help() {
    echo "Usage:    run.sh [-tool   { irun | questa | vcs} ]  --> specify what simulator to use (default: irun)"
    echo "          run.sh -h[elp]                           --> print this message"
    echo "Example: ./run.sh -tool irun"
}

# Compile and run with irun
run_with_irun() {
    make run_irun
}
