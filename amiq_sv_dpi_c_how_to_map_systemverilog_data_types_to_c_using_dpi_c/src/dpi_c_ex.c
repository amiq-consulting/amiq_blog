...
void compute_logic(svLogic i_value, svLogic *result) {
...
svLogic get_logic(svLogic i_value) {
	svLogic result = sv_0;
...
void compute_logic_vector(svLogicVecVal *i_value, svLogicVecVal *result,
		int asize) {
...
svLogicVecVal * get_logic_vector(svLogicVecVal *i_value, int asize) {
...
void compute_reg_vector(svLogicVecVal *i_value, svLogicVecVal *result,
		int asize) {
...
svLogicVecVal * get_reg_vector(svLogicVecVal *i_value, int asize) {
	svLogicVecVal *result = malloc(sizeof(svLogicVecVal));
